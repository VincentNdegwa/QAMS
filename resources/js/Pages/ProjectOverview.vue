    ...
    <SingleProject>
            ...
            <div class="col-12 box-shadow">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 mt-3">
                        <div class="col-12 text-light">Module Count</div>
                        <div class="col-12">
                            <apexchart
                                type="bar"
                                :options="Baroptions"
        ...
        <div class="row top-stats mt-3">
            ...
            <div class="col-12 col-lg-4">
                <div
                    class="w-100 d-flex flex-column align-items-center h-100 justify-content-between"
                >
                    <div
                    ...
                    >
                        ...
                        <div class="h6 text-center text-primary">Issues</div>
                        <div class="text-center h2 text-light">
                            {{ data.issuesCount }}
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            series: [
                this.data.completedCases,
                this.data.totalCases - this.data.completedCases,
            ],
            options: {
            ...
            Baroptions: {
                ...
                xaxis: {
                    categories: this.data?.moduleCount?.map(
            ...
            Barseries: [
                {
                    name: "Test Cases",
                    data: this.data?.moduleCount?.map(
                        (item) => item.test_count
                    ),
                },
            ],
        };
